            ...
            <SurfaceCard variant="stage" hover="lift" className="player-hero-stage p-5 sm:p-6 lg:p-7">
              ...
              <div className="player-hero-stage__content">
                <div className="player-hero-stage__masthead">
                  ...
                  <div className="w-full max-w-[360px] rounded-[18px] border border-white/10 bg-white/[0.04] p-3 shadow-[0_14px_36px_rgba(0,0,0,0.18)] backdrop-blur">
                    <p className="mb-3 text-[11px] font-semibold uppercase tracking-[0.16em] text-white/48">
                      For partnership contact
                    </p>
                    <div className="grid grid-cols-2 gap-2">
                      <a
                        href={yemenLinks.telegram}
                        target="_blank"
